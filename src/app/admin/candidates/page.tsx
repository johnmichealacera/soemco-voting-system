    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="module-title text-3xl font-bold mb-0">Candidate Management</h1>
            <p className="text-gray-600 mt-2">
              Manage candidates and their nominations
            </p>
          </div>
          <Button
        ...
        <Card className="border-0 shadow-md">
          <CardHeader className="bg-white border-b" style={{ borderColor: '#dee2e6' }}>
            ...
            <CardDescription>
              View and manage candidate nominations and status
            </CardDescription>
          </CardHeader>
