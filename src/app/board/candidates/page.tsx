...
export default async function BoardCandidatesPage() {
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          <h1 className="module-title text-3xl font-bold mb-0">Candidates</h1>
          <p className="text-gray-600 mt-2">
            Manage candidate nominations and approvals
          </p>
        </div>
